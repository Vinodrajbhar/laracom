      ...
      <ul>
        ...
        <li><a href="#"><span>Elements 1</span></a> 
          ...
          <ul>
            ...
            <li><a href="glyphicons.html"><span>Glyphicons</span></a></li><li><a href="shortcode-post.html"><span>post</span></a></li>
          </ul>
          <!--sub sub category--> 
        </li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-3 col-xs-12"> 
            <!-- Header Logo -->
            <div class="logo"><a title="e-commerce" href="index.html"><img alt="e-commerce" src="{{ asset('public/images/logo.png')}}"></a> </div>
            <!-- End Header Logo --> 
          </div>  <!--support client-->
                  ...
                  <div class="product-item">
                    <div class="item-inner fadeInUp">
                      ...
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <img class="first-img" src="{{ asset('public/images/products/img01.jpg')}}" alt=""> <img class="hover-img" src="{{ asset('public/images/products/img01.jpg')}}" alt="">
                ...
                <li class="menu-item depth-1 product menucol-1-4 withimage">
                  <div class="product-item">
                    <div class="item-inner fadeInUp">
                      <div class="icon-sale-label sale-left">Sale</div>
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <img class="first-img" src="{{ asset('public/images/products/img18.jpg')}}" alt=""> <img class="hover-img" src="{{ asset('public/images/products/img18.jpg')}}" alt="">
                          <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                        </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                ...
                <li class="menu-item depth-1 product menucol-1-4 withimage">
                  <div class="product-item">
                    <div class="item-inner fadeInUp">
                      ...
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <img class="first-img" src="{{ asset('public/images/products/img19.jpg')}}" alt=""> <img class="hover-img" src="{{ asset('public/images/products/img19.jpg')}}" alt="">
                          <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                        </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                ...
                <li class="menu-item depth-1 product menucol-1-4 withimage">
                  <div class="product-item">
                    <div class="item-inner fadeInUp">
                      ...
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <img class="first-img" src="{{ asset('public/images/products/img20.jpg')}}" alt=""> <img class="hover-img" src="{{ asset('public/images/products/img20.jpg')}}" alt="">
                          <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                        </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="box-authentication">
                ...
                <input id="emmail_register" type="text" class="form-control">
                 <p class="forgot-pass"> <a href="{{ url('/login')}}">Already registered cllieck here!</a> || <a href="#">Forgot your password?</a></p>
...
<!--jquery-slider js --> 
<script type="text/javascript" src="{{ asset('public/js/slider.html')}}"></script> 

<!-- megamenu js --> 
<script type="text/javascript" src="{{ asset('public/js/megamenu.j')}}s"></script> 
...
<!-- jquery.waypoints js --> <script type="text/javascript" src="{{ asset('public/js/waypoints.js')}}"></script>
</body>
</html>